...
document.write(x);
      ...
      But trying to multiply a number with string values that aren’t numbers, like 'sololearn' * 5 will return NaN (Not a Number).
...
Increment & Decrement
      ...
      What are increment and decrement are used to change the sign of the number to "+" or "-" Adding or subtracting 1 from a number
